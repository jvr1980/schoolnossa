...
def _find_input(school_type: str) -> Path:
    ...
    # Frankfurt: intermediate files don't have 'website' column, but final/raw do.
    # Prefer final > raw > intermediate (final has all enrichments + website URLs)
    candidates = [
        FINAL_DIR / f"frankfurt_{school_type}_school_master_table_final.csv",
        FINAL_DIR / f"frankfurt_{school_type}_school_master_table.csv",
