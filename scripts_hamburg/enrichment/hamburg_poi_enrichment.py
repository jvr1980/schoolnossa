#!/usr/bin/env python3
"""
Hamburg School POI Enrichment

Enriches Hamburg school data with nearby Points of Interest using Google Places API (New).

This script:
1. Loads Hamburg school data with lat/lon coordinates
...
# Checkpoint file
CHECKPOINT_FILE = INTERMEDIATE_DIR / "poi_enrichment_checkpoint.json"
PROGRESS_FILE = INTERMEDIATE_DIR / "poi_enrichment_progress.csv"
...
def main():
    """Main function."""
    logger.info("="*70)
    logger.info("HAMBURG SCHOOL POI ENRICHMENT")
    logger.info("="*70)
    ...
    output_file = INTERMEDIATE_DIR / "hamburg_schools_with_pois.csv"
